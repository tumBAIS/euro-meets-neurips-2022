...
parser.add_argument("--model_name", type=str, default="NeuralNetwork_samples-test_instances-test_runtime-test_featureset-dynamicstatic_iteration-1")
...
parser.add_argument("--instance_directory", type=str, help="specify directory with instances to run", default="./validation_instances/")
